...
/* Fixes for Mainline Kernel 6.11+ / 6.18 porting */
#ifndef MPP_MAINLINE_SHIM_H
#define MPP_MAINLINE_SHIM_H

/* IOMMU function redirection to No-Ops */
#define rockchip_iommu_disable(dev)         (0)
#define rockchip_iommu_enable(dev)          (0)
#define rockchip_iommu_tlb_invalidate(dev)  (0)
#define rockchip_iommu_force_reset(dev)     (0)
#define rockchip_iommu_mask_irq(dev)        (0)
#define rockchip_iommu_unmask_irq(dev)      (0)

#endif /* MPP_MAINLINE_SHIM_H */
